...
public interface AreaRepository extends JpaRepository<Area,Long> {
    ...
    public String selectSidoCdBySidoNm(@Param("sido_nm") String sido_nm);

    @Query(nativeQuery = true, value="SELECT a.area_cd from manddang.area a where a.sido_cd = :sido_cd and a.area_nm = :area_nm")
    public String selectAreaCdByAreaNm(@Param("sido_cd") String sido_cd , @Param("area_nm") String area_nm);
}
